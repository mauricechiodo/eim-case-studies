...
Compare the training and upbringing of a longbow archer to that of a mathematician, which also requires focused practice from a young age. Undergraduate mathematicians will have practised some form of numeracy since ages 3-4, each academic year building upon the last, and for those that really take to it (those mathematicians to be), it pervasively changes the way a person's mind functions and how they consider the world. Mathematicians see patterns in the world where others may not, they explain complex phenomena by reducing them to axiomatised systems. And mathematics is taught with such abstraction from the real world that its effects are rarely considered: it is done with no code of conduct.
