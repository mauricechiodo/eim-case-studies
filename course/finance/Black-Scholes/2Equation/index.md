...
The key assumption to Black and Scholes' work is that the underlying stock price $S$ follows a <a href="/course/course/finance/Black-Scholes/Brownian-motion" target="_blank">geometric Brownian motion</a> with drift $\mu$ and variance parameter $\sigma^2$. In the language of stochastic calculus, this states that
...
Now we introduce a hedged portfolio that is <a href="/course/course/finance/Black-Scholes/Positions" target="_blank">short</a> one option (with value $V$), and <a href="/course/course/finance/Black-Scholes/Positions" target="_blank">long</a> $\frac{\partial V}{\partial S}$ shares at time $t$, the value $\Pi$ of these holdings is
...
To read about the solution to this differential equation, check out [the formula](course/finance/Black-Scholes/3Formula).
 ...
 <a href="/course/course/finance/Black-Scholes/3Formula">
 <img src="/course/media/B-S/3Formula.jpg"/>
 </a>
